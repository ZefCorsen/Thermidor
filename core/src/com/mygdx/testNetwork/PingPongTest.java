...
public class PingPongTest extends KyronetTestCase {

    public void testPingPong() throws IOException {
      //  final Player p = new Player(0,0,"lkdjfg");
        ...
        server.addListener(new Listener() {
            public void connected(Connection connection) {
                System.out.println("1er Envoi");
        //        connection.sendTCP(p);
                //          connection.sendUDP(dataUDP); // Note UDP ping pong stops if a UDP packet is lost.
            }

            public void received(Connection connection, Object object) {
                if (object instanceof BodyModel) {
                    BodyModel data = (BodyModel) object;

                    System.out.println("Server recu");
...
// ----
    ...
    private void register2(Kryo kryo) {
