...
/**
 * Created by Jerem on 03/02/2015.
 */
...
import static com.mygdx.world.Assets.*;
...
public class Physics4 extends ApplicationAdapter {
    ...
    public void create() {
        ...
        img = new Texture(Gdx.files.internal("images/bonhomme.png"));
        float ppuX =  Gdx.graphics.getWidth()/ CAMERA_WIDTH;
        float ppuY =  Gdx.graphics.getHeight() / CAMERA_HEIGHT;
        // Create two identical sprites slightly offset from each other vertically
        sprite = new Sprite(img);
        sprite.setSize(Player.SIZE * ppuX, Player.SIZE*ppuY );
        sprite.setPosition(-sprite.getWidth()/2,-sprite.getHeight()/2 +200);
        sprite2 = new Sprite(img);
        sprite2.setSize(Player.SIZE * ppuX, Player.SIZE*ppuY );
        ...
        fixtureDef2.filter.maskBits = WORLD_ENTITY|PHYSICS_ENTITY;
        ...
        fixtureDef3.filter.maskBits  = WORLD_ENTITY|PHYSICS_ENTITY;
/*
        EdgeShape edgeShape = new EdgeShape();
        edgeShape.set(-w/2,-h/2,w/2,-h/2);
        edgeShape.setVertex0(-w/2,h/2);
        edgeShape.setVertex3(w/2,h/2);
        fixtureDef3.shape = edgeShape;
        ChainShape chaineShape = new ChainShape();
        chaineShape.setNextVertex(-w/2,h/2);
        chaineShape.setNextVertex(-w/2,-h/2);
        chaineShape.setNextVertex(w/2,-h/2);
        chaineShape.setNextVertex(w/2,h/2);
*/
